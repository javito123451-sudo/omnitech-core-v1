...
import {
  ...
  Key, Activity, ShieldCheck, Rocket,
} from "lucide-react";
...
const ccNav = [
  {
    ...
    items: [
      ...
      { icon: Rocket,          label: "Onboard Wizard",  href: "/control-center/onboard-wizard" },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Activity,        label: "Diagnóstico",     href: "/control-center/diagnostics"  },
    ],
  },
];
