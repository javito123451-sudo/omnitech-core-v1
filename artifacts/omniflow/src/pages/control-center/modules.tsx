...
const MODULE_ICONS: Record<string, string> = {
  ...
  omni_seller: "🧭", a_medida: "🚚", omni_fleet: "🛣️", omni_taller: "🔧",
};
const MODULE_COLORS: Record<string, string> = {
  ...
  omni_leads: "from-orange-600 to-red-600", omni_seller: "from-teal-600 to-cyan-600",
  a_medida: "from-amber-500 to-yellow-600",
