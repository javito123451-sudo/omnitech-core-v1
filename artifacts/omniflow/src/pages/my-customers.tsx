...
import {
  Search, UserCheck, Eye, Phone, Mail, Building2,
...
function fetchMyCustomers(): Promise<CustomerRow[]> {
  return authFetch(`${import.meta.env.BASE_URL}api/clients/my-customers`).then(r => r.json());
}
    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-5">
      ...
      {isLoading ? (
        ...
        <p className="text-muted-foreground py-12 text-center">
          No tienes clientes activos asignados.
        </p>
      ) : (
